...
class CNN_Model(nn.Module):
    ...
    def __init__(self, input_size):
        ...
        self.conv_layer1 = nn.Conv2d(in_channels=1, out_channels=OUT_CHANNELS, kernel_size=kernel_size, padding=1, dilation=1)
        self.conv_layer2 = nn.Conv2d(in_channels=OUT_CHANNELS, out_channels=OUT_CHANNELS*2, kernel_size=kernel_size, padding=1, dilation=1)
        ...
        self.conv_layer3 = nn.Conv2d(in_channels=OUT_CHANNELS*2, out_channels=OUT_CHANNELS*2*2, kernel_size=kernel_size, padding=1, dilation=1)
        self.conv_layer4 = nn.Conv2d(in_channels=OUT_CHANNELS*2*2, out_channels=OUT_CHANNELS*2*2*2, kernel_size=kernel_size, padding=1, dilation=1)
    ...
    def forward(self, x):
        #print('lvl: 1')
        #print(x.size())
        #torch.Size([1, 1, 30, 30]) => 1=batch 1=chanal 30=width; 30=hight
