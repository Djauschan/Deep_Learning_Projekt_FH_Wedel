<template>
    <div class="home-container">
        <div class="home-header">
            <img alt="image" src="/external/fh_wedel_logo.svg-200h.png" class="home-image" />
                ...
                <div class="home-container02">
                    <div class="home-profile">
                        <div class="home-container03">
                            <img alt="image" src="/profil-200h.jpg" class="home-image1" />
                        </div>
                    ...
                    <div class="home-container07">
                        <div class="home-container08">
                            <div class="home-container09">
                                ...
                                <span class="home-text02">Dashboard</span>
                            </div>
                            <div class="home-container10">
                                <svg viewBox="0 0 1024 1024" class="home-icon14">
                                    <path d="M86 682l170-170v128h640v86h-640v128zM938 342l-170 170v-128h-640v-86h640v-128z">
                                    </path>
                                </svg>
                                <span class="home-text03">Transaktionen</span>
                            </div>
                            <div class="home-container11">
                                <svg viewBox="0 0 1024 1024" class="home-icon16">
                                    <path
                                        d="M640 790q102 0 180-68l76 76q-108 98-256 98-124 0-223-72t-139-184h-192l42-86h130q-2-12-2-42t2-42h-172l42-86h150q40-112 139-184t223-72q60 0 136 29t120 69l-76 76q-78-68-180-68-70 0-142 44t-104 106h288l-42 86h-274q-4 28-4 42t4 42h316l-42 86h-246q32 62 104 106t142 44z">
                                    </path>
                                </svg>
                                <span class="home-text04">Guthaben</span>
                            </div>
                            <div class="home-container12">
                                <svg viewBox="0 0 1024 1024" class="home-icon18">
                                    <path
                                        d="M832 128q34 0 60 26t26 60v596q0 34-26 60t-60 26h-640q-34 0-60-26t-26-60v-596q0-34 26-60t60-26h640zM832 814v-600h-640v600h640zM726 726h-86v-172h86v172zM554 726h-84v-428h84v428zM384 726h-86v-300h86v300z">
                                    </path>
                                </svg>
                                <span class="home-text05">Statistiken</span>
                            </div>
                            <div class="home-container13">
                                ...
                                <span class="home-text06">Persönlich</span>
                            </div>
                            <div class="home-container14">
                                ...
                                <span class="home-text07">Nachrichten</span>
                            </div>
                            <div class="home-container16">
                                ...
                                <span class="home-text08">Einstellungen</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="home-container20">
                        <div class="home-container21">
                            ...
                            <div class="home-container23">
                                <div class="home-container24"><span>aktives Modell</span></div>
                            ...
                            <div class="home-container27">
                                <div class="home-container28">
                                    <div class="home-container29"><span>Modell Guthaben</span></div>
                            ...
                            <div class="home-container32">
                                <div class="home-container33">
                                    <div class="home-container34"><span>Traiding Tags</span></div>
                                    <div class="home-container35">
                                        ...
                                        <select>
                                            <option value="Option 1" selected>Umweltfreundlich</option>
                            ...
                            <div class="home-container37">
                                <div class="home-container38"><span>Los geht&apos;s!</span></div>
    ...
    <body>
      <div class='credit-card'>
        ...
        <div class='card-details'>
          <div class='expiration-date'>
            <label for='expirationDate'>Gültig bis</label>
        ...
        <div class='cardholder-name'>
          <label for='cardholderName'>Besitzer</label>
          <input type='text' id='cardholderName' placeholder='Thomas Parchmann'>
        </div>
      </div>
      <script src='script.js'></script>
                        ...
                        <div class="home-container51"></div>
                    </div>
                    <div class="home-container52"></div>
                    <div class="home-container53">
                        <div class="home-container54"></div>
      ...
      <script>
        ...
        data.forEach((value) => {
          ...
          x += barWidth + barSpacing;
                        ...
                        <div class="home-container58"></div>
                        <div class="home-container59"></div>
                        <div class="home-container60"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="home-container61"></div>
    </div>
</template>
