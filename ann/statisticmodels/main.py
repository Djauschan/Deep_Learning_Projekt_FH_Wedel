...
import os
from PredicitonInterface import ArimaInterface
from PredicitonInterface import ETSInterface
from PredicitonInterface import historicAverageInterface
from PredicitonInterface import ThetaInterface
from PredicitonInterface import NaiveInterface
...
#     modell=Window_average()
#     modell.fitAndSave(y_train, i)
#     # ergebnis= modell.loadAndPredict('statisticmodels\models\savedModels\AAL_WindowAverage.pkl',50)
#     # print(ergebnis.head())

#     # plt.style.use('fivethirtyeight')
#     # plt.plot(list(y_test['ds'].iloc[:50]),list(ergebnis['WindowAverage']),marker='o', label='WA')
#     # plt.plot(list(y_test['ds'].iloc[:50]),list(y_test['y'].iloc[:50]),marker='x',label='echte Werte')
