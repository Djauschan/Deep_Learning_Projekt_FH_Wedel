...
from ml_model_min import LinearRegressionModel, RandomForestModel, GradientBoostingModel, SVMModel
...
for idx, symbol in enumerate(symbols):
    ...
    df_min = cleaner.minute() #daily business days, Wert von 16 Uhr
    data_columns = df_min.columns
    ...
    data_pip = pipeline.fit_transform(data, 'min')

    # Verwendung der Klasse zum splitten der Daten
    splitter = DataSplitter(data)
    splitter.split_by_hour_60min(pd.Timestamp('2021-01-03 16:00:01')) #Split zu diesen Datum mit beachtung der 60min  #Final 03.01.2021 

    train_data = splitter.get_train_data()  #2021-01-03 16:00:00
    test_data = splitter.get_test_data()    #2021-01-03 15:01:00 -> beim splitt - 60min wegen den LagFeatures

    #splitt train und test data durch pipeline
    train_data = pipeline.fit_transform(train_data, 'min') #2021-01-03 16:00:00
    test_data = pipeline.fit_transform(test_data, 'min')   #2021-01-04 09:30:00 -> passt prediction ab 4.1. 9.30 Uhr
    ...
    pfad_data = 'ML_Modelle/saved_pkl_model_min/Data'
...
############### LR ##################### 
lr_model = ABC_LinearRegressionModel_min()

lr_predictions = lr_model.predict("AAPL", pd.Timestamp('2021-01-05 10:00:00'), pd.Timestamp('2021-01-05 10:40:00'), 20)
...
gbm_predictions = gbm_model.predict("AAPL", pd.Timestamp('2021-01-05 10:00:00'), pd.Timestamp('2021-01-05 10:40:00'), 20)
print("gbm_predictions")
print(gbm_predictions)

############### SVM ##################### 
# svm_model = ABC_SVMModel_min()

# svm_predictions = svm_model.predict("AAPL", pd.Timestamp('2021-01-05 10:00:00'), pd.Timestamp('2021-01-05 10:40:00'), 20)
