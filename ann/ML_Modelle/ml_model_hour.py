...
class LinearRegressionModel(BaseModel):
    ...
    def fitandsave(self, X_train, y_train, symbol):
        ...
        path = f"ML_Modelle/saved_pkl_model_hour/LR-Model/{symbol}_lr_model.pkl"
...
class RandomForestModel(BaseModel):
    ...
    def fitandsave(self, X_train, y_train, symbol):
        self.model.fit(X_train, y_train)
        path = f"ML_Modelle/saved_pkl_model_hour/RF-Model/{symbol}_rf_model.pkl"
        with open(path, 'wb') as file:
            pickle.dump(self.model, file)
...
class GradientBoostingModel(BaseModel):
    ...
    def fitandsave(self, X_train, y_train, symbol):
        self.model.fit(X_train, y_train)
        path = f"ML_Modelle/saved_pkl_model_hour/GBM-Model/{symbol}_gbm_model.pkl"
        with open(path, 'wb') as file:
            pickle.dump(self.model, file)
...
class SVMModel(BaseModel):
    ...
    def fitandsave(self, X_train, y_train, symbol):
        self.model.fit(X_train, y_train)
        path = f"ML_Modelle/saved_pkl_model_hour/SVM-Model/{symbol}_svm_model.pkl"
        with open(path, 'wb') as file:
            pickle.dump(self.model, file)
