...
class executer:
    ...
    def startTraining_w(self):
        ...
        SWING2_CONFIG_PATH = "C:\\Projekte\\__PorjectDeepLearningMain\\Deep_Learning\\CNN\\configs\\training\\baseModel_Langfristig_3.yml"
        # start 12:50
        importer: Importer = Importer(SWING2_CONFIG_PATH)
        trainExe = CNN_TimeSeriesModel(importer)
        trainExe.exe()
        ...
        SWING2_CONFIG_PATH = "C:\\Projekte\\__PorjectDeepLearningMain\\Deep_Learning\\CNN\\configs\\training\\baseModel_Langfristig_4.yml"
        # start 12:50
        importer: Importer = Importer(SWING2_CONFIG_PATH)
        trainExe = CNN_TimeSeriesModel(importer)
        trainExe.exe()
