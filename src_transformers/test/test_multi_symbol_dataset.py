...
@pytest.mark.parametrize(
    "length, subseries_amount, validation_split, encoder_input_length, decoder_input_length",
    [
        (100, 5, 0.3, 2, 1),
        (103, 5, 0.3, 2, 1),
    ]
...
def test_get_subset_indices(length: int,
    ...
    mock_dataset.decoder_input_length = decoder_input_length
    ...
    validation_indices_result = list(range(4, 18)) + list(range(34, 38)) + list(
